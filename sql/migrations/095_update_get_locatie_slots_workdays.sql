-- =====================================================
-- Update get_locatie_available_slots to support 'workdays'
-- File: sql/migrations/095_update_get_locatie_slots_workdays.sql
-- =====================================================

\echo 'Migration 095: Update get_locatie_available_slots for workdays'

-- Drop the existing function
DROP FUNCTION IF EXISTS ihw.get_locatie_available_slots(uuid, date);
...
COMMENT ON FUNCTION ihw.get_locatie_available_slots IS 
  'Bereken beschikbare tijdslots voor een locatie op een specifieke datum, inclusief workdays support';

\echo '✅ Updated get_locatie_available_slots function with workdays support'
