            ...
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              {dossier.ceremonie ? (
                ...
                <>
                  ...
                  <button
                    onClick={() => router.push(`/dossier/${dossierId}/ceremonie`)}
                    className="inline-flex items-center gap-2 bg-[#2e75d4] text-white font-sans text-base font-bold px-6 py-3 rounded hover:bg-[#4d8ada] focus:outline-none focus:ring-2 focus:ring-[#2e75d4] focus:ring-offset-2 transition-colors"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
