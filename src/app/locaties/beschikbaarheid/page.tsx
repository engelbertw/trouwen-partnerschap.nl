...
export default function LocatiesBeschikbaarheidPage(): JSX.Element {
  const [data, setData] = useState<LocatieData | null>(null);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('/api/locaties/beschikbaarheid');
    ...
    const fetchCalendarToken = async () => {
      try {
        const response = await fetch('/api/locaties/calendar-token');
        const result = await response.json();
      ...
      <div className="bg-blue-700 text-white">
        <div className="max-w-4xl mx-auto px-6 py-4">
          <h1 className="font-sans text-lg font-normal">
            Locatie Portal - Beschikbaarheidsbeheer
          </h1>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Beheer de beschikbaarheid voor deze locatie
            </p>
          </div>
          ...
          <div className="bg-blue-50 border-l-4 border-blue-600 p-6 rounded mb-8">
            <div className="flex items-start">
              ...
              <div className="text-sm text-blue-900">
                ...
                <p>
                  Gebruik de kalender om de beschikbaarheid in te stellen:
                </p>
                <ul className="list-disc ml-5 mt-2 space-y-1">
                  <li><strong>Terugkerende beschikbaarheid</strong> - Stel patronen in (bijv. elke maandag)</li>
                  <li><strong>Blokkeer datums</strong> - Markeer onderhoudsdagen of andere afwezigheden</li>
          ...
          <div className="text-center">
            <Link
              href={`/gemeente/beheer/locaties/${data.id}/calendar`}
